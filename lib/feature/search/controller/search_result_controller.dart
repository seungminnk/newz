...
class SearchResultController extends GetxController {
  ...
  void requestSearchData() async {
    ...
    SearchNewsData.SearchResponseOnlyDataDto searchResponseOnlyDataDto =
        SearchNewsData.SearchResponseOnlyDataDto.fromJson(response.data);

    searchPageModel.isLastPage =
        searchResponseOnlyDataDto.news!.length < searchPageModel.size;
    ...
    if (searchPageModel.isLastPage) {
      ...
      pagingController.appendPage(
          searchResponseOnlyDataDto.news!, searchPageModel.page);
